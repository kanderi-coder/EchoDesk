...
class ToolManager:
    ...
    def register_default_tools(self) -> dict[str, Any]:
        ...
        try:
            ...
            llm_engine = llm_module.LLMEngine(llm_module.OllamaProvider())
            self.register_tool("LLMEngine", llm_engine)
            self.register_tool("InternetEngine", internet_module.InternetEngine(llm_engine=llm_engine))
            ...
            step_executor = execution_module.ExecutionStepExecutor(self._tools)
            self.register_tool("ExecutionEngine", execution_module.ExecutionEngine(step_executor=step_executor))
